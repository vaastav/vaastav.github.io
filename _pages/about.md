...
Here are some of my relevant academic documents:

+ [CV, Feb 2026](/assets/files/cv.pdf){:target="\_blank"}
+ [Research Statement, Dec 2025](/assets/pdf/vaastav_research_statement.pdf){:target="\_blank"}
+ [Teaching Statement, Dec 2025](/assets/pdf/vaastav_teaching_statement.pdf){:target="\_blank"}
+ [Diversity Statement, Dec 2025](/assets/pdf/vaastav_diversity_statement.pdf){:target="\_blank"}
